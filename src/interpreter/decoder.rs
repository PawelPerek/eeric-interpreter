...
impl Decoder {
    ...
    pub fn decode_text_section(
        ...
        let instruction = match Self::rename(mnemonic) {
            ...
            "fsqrt.s" => Fsqrts(r(op)?),
            "fsgnj.s" => Fsgnjs(r(op)?),
            "fsgnjn.s" => Fsgnjns(r(op)?),
            "fsgnjx.s" => Fsgnjxs(r(op)?),
            "fmin.s" => Fmins(r(op)?),
            "fmax.s" => Fmaxs(r(op)?),
            "fcvt.w.s" => Fcvtws(r(op)?),
            "fcvt.wu.s" => Fcvtwus(r(op)?),
            "fmv.x.w" => Fmvxw(r(op)?),
            "feq.s" => Feqs(r(op)?),
            "flt.s" => Flts(r(op)?),
            "fle.s" => Fles(r(op)?),
            "fclass.s" => Fclasss(r(op)?),
            "fcvt.s.w" => Fcvtsw(r(op)?),
            "fcvt.s.wu" => Fcvtswu(r(op)?),
            "fmv.w.x" => Fmvwx(r(op)?),
            "fcvt.l.s" => Fcvtls(r(op)?),
            "fcvt.lu.s" => Fcvtlus(r(op)?),
            ...
            "fsqrt.d" => Fsqrtd(r(op)?),
            "fsgnj.d" => Fsgnjd(r(op)?),
            "fsgnjn.d" => Fsgnjnd(r(op)?),
            "fsgnjx.d" => Fsgnjxd(r(op)?),
            "fmin.d" => Fmind(r(op)?),
            "fmax.d" => Fmaxd(r(op)?),
            "fcvt.s.d" => Fcvtsd(r(op)?),
            "fcvt.d.s" => Fcvtds(r(op)?),
            "feq.d" => Feqd(r(op)?),
            "flt.d" => Fltd(r(op)?),
            "fle.d" => Fled(r(op)?),
            "fclass.d" => Fclassd(r(op)?),
            "fcvt.w.d" => Fcvtwd(r(op)?),
            "fcvt.wu.d" => Fcvtwud(r(op)?),
            "fcvt.d.w" => Fcvtdw(r(op)?),
            "fcvt.d.wu" => Fcvtdwu(r(op)?),
            "fcvt.l.d" => Fcvtld(r(op)?),
            "fcvt.lu.d" => Fcvtlud(r(op)?),
            "fmv.x.d" => Fmvxd(r(op)?),
            "fcvt.d.l" => Fcvtdl(r(op)?),
            "fcvt.d.lu" => Fcvtdlu(r(op)?),
            "fmv.d.x" => Fmvdx(r(op)?),
